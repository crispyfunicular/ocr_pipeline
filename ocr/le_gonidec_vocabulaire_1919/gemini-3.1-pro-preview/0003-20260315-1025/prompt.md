...
Pay close attention to similar letters: **s/z**, **c/e**, **o/a**, **h/b**, **i/l/t**, **u/v**, as well as **rn/m** in old typography. When in doubt, stick to the most likely reading without guessing words and report the case.
...
- **Abréviations :** Les abréviations suivantes (listées sur la page 13) doivent être systématiquement ignorées et ne pas être incluses dans le texte extrait :
  ...
  - **f.** = féminin.
  - **fam.** = familier.
  - **fig.** = figuré. **Exception** : lorsque `au fig.` ou `fig.` qualifie le sens du mot vedette français (par ex. `éclore ; au fig., sevel`), ne pas supprimer mais **développer l'abréviation** dans le champ `français` : `"français": "éclore au figuré"`. L'indication est sémantiquement utile pour distinguer le sens propre du sens figuré.
  - **g.** = genre.
  - **infin.** = infinitif.
  - **irrég.** = irrégulier.
  - **Le Gon.** = Le Gonidec.
